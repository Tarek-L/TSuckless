...
static const char col_gray2[] =
    "#504945"; /* Border color for unfocused windows */
static const char col_gray3[] =
    "#ebdbb2"; /* Foreground color for unfocused text */
static const char col_gray4[] =
    "#d5c4a1"; /* Foreground color for focused text */
static const char col_cyan[] =
    "#958500"; /* Background and border color for focused windows */
